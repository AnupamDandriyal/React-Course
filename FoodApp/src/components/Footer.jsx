...
const Footer = () => {
  return (
    <div id='footer' className="footer w-full text-[#d9d9d9] bg-[#323232] flex flex-col items-center gap-[20px] py-[20px] px-[8vw] pt-[80px] mt-[100px]">
      ...
      <div className="footer-right flex flex-col items-start gap-[20px]">
        ...
        <ul>
          ...
          <li className="cursor-pointer hover:text-red-500 text-wrap">reachus@tomato@delgo.in</li>
        </ul>
      </div>
      </div>
      <hr className=" w-full"/>
